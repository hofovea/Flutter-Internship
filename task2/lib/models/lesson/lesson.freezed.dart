...
mixin _$Lesson {
  ...
  double get levelIndicator => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      level: null == level
          ...
          : level // ignore: cast_nullable_to_non_nullable
              as String,
      levelIndicator: null == levelIndicator
          ? _value.levelIndicator
          : levelIndicator // ignore: cast_nullable_to_non_nullable
              as double,
      price: null == price
          ? _value.price
...
class _$_Lesson implements _Lesson {
  ...
  @override
  String toString() {
    return 'Lesson(title: $title, level: $level, levelIndicator: $levelIndicator, price: $price, content: $content, iconName: $iconName)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.levelIndicator, levelIndicator) ||
                other.levelIndicator == levelIndicator) &&
  ...
  int get hashCode => Object.hash(
      runtimeType, title, level, levelIndicator, price, content, iconName);
...
abstract class _Lesson implements Lesson {
  const factory _Lesson(
      ...
      required final double levelIndicator,
